...
@section('content')
    ...
    <thead class="bg-gray-100">
        <tr>
            ...
            <th class="p-3 text-left border-b border-gray-300">Mantenimiento</th> <!-- NUEVA COLUMNA -->
        </tr>
    </thead>
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="13" class="p-3 text-center text-gray-500">No hay equipos registrados.</td>
            </tr>
        @endforelse
    </tbody>
</table>
